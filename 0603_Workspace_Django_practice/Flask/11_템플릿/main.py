...
def index():
    ...
    # 지정된 html 파일을 가지고 데이터를 통해 유동적으로 HTML를 만들기 위해 사용하는
    # 문법을 jinja2라고 부른다.
...
#     print(f'a1 : {a1}')
#     print(f'a2 : {a2}')
#     print(f'a3 : {a3}') #a1,a2를 제외한 나머지 value들(300,400,500,600)을 튜플로 만들어 a3에 넣어줌
#     print(f'a4 : {a4}') #dictionary로 값들이 넘어옴
